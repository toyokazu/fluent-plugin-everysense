...
- **レシピ**: **レストランオーナー** から **ファームオーナー** に送られる欲しいデータの条件。**ファームオーナー** は送られてきたレシピに対してデータを送信しても良いかどうか承認処理を行います。承認されたレシピでは承認した **ファームオーナー** のデバイス or ファーム (複数のデバイスを含むことが可能)に送られたデータを取得することができます。
